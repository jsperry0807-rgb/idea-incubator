...
const STATUS_CLASSES: Record<IdeaStatus, string> = {
  IDEA: "bg-zinc-500/10 text-zinc-600 border-zinc-500/30",
  PLANNING: "bg-sky-500/10 text-sky-700 border-sky-500/30",
  PLANNED: "bg-amber-500/10 text-amber-700 border-amber-500/30",
  IN_PROGRESS: "bg-orange-500/10 text-orange-700 border-orange-500/30",
  DONE: "bg-emerald-500/10 text-emerald-700 border-emerald-500/30",
  ARCHIVED: "bg-zinc-400/10 text-zinc-500 border-zinc-400/30",
};
