...
export const es: LocaleMessages = {
  ...
  ideas: {
    ...
    sharing: {
      ...
      subtitle: "Invita a colaborar en {{idea}}.",
      inviteTitle: "Invitar",
      ...
      invite: "Invitar",
      inviting: "Invitando…",
      inviteSuccess: "Compartido con {{email}}",
      inviteConflict: "Este usuario ya tiene acceso.",
      inviteNotFound: "No se encontró ningún usuario con ese correo.",
      inviteError: "Ocurrió un error al compartir esta idea.",
      accessListTitle: "Personas con acceso",
      emptyAccess: "Todavía no se ha invitado a nadie.",
      changeRole: "Cambiar el rol de {{name}}",
      remove: "Quitar",
      roleUpdated: "Rol actualizado",
      removed: "Acceso eliminado",
      updateRoleError: "Ocurrió un error al actualizar el rol.",
      removeError: "Ocurrió un error al eliminar el acceso.",
      loadError: "Ocurrió un error al cargar el acceso de esta idea.",
      cancel: "Cancelar",
    },
    comments: {
      loadError: "Algo salió mal al cargar los comentarios.",
      empty: "Aún no hay comentarios. Inicia la conversación.",
      placeholder: "Añadir un comentario…",
      submit: "Comentar",
      submitting: "Publicando…",
      createError: "Algo salió mal al publicar tu comentario.",
      updateError: "Algo salió mal al actualizar el comentario.",
      deleteError: "Algo salió mal al eliminar el comentario.",
      save: "Guardar",
      cancel: "Cancelar",
      edit: "Editar",
      delete: "Eliminar",
